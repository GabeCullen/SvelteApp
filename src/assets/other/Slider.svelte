<script>
    ...
    export let id = null;
    export let color1 = "#6185ff";
    export let color2 = "#9c65ff";
    export let value =
  ...
  <style>
    ...
    .range__thumb {
      display: flex;
      content: url("/images/fan_dark.png");
      padding: 3px;
      align-items: center;
      ...
      width: 15px;
      height: 15px;
      background-color: var(--thumb-bgcolor, rgb(24, 24, 24));
      cursor: pointer;
      border-radius: 999px;
      margin-top: -8px;
    ...
    .range__tooltip {
      ...
      position: absolute;
      top: -33px;
      color: var(--tooltip-text, rgb(54, 54, 54));
      width: 38px;
      padding: 4px 0;
      border-radius: 4px;
      text-align: center;
